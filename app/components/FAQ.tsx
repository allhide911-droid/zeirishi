...
const faqs = [
  ...
  {
    question: "個人事業主・フリーランスでも対応していただけますか？",
    answer:
      "もちろんです。確定申告・帳簿作成・節税対策など、個人事業主・フリーランスの方のニーズに幅広く対応しています。開業直後の方もお気軽にご相談ください。",
  },
  {
    question: "オンラインでの相談は可能ですか？",
    answer:
      "Zoom・Google Meet等を使ったオンライン相談に対応しています。遠方の方や外出が難しい方もご安心ください。",
  },
  {
    question: "単発・スポットでの依頼は可能ですか？",
    answer:
      "単発・スポットでのご依頼も歓迎しています。顧問契約が必要なケースは少なく、まずはお気軽にご相談ください。",
  },
  {
    question: "費用はどのくらいかかりますか？",
    answer:
      "ご依頼内容によって異なりますが、初回相談時に内容を確認した上で明確なお見積りをご提示します。追加費用が発生する場合も事前にご説明しますのでご安心ください。",
  },
];
